...
{
	public class ContractPartnerPattern_MMap : EntityTypeConfiguration<ContractPartnerPattern_M>
	{
		public ContractPartnerPattern_MMap()
		{
			// Primary Key
			this.HasKey(t => new { t.PartnerMainC, t.PartnerSubC, t.ApplyD, t.CustomerMainC, t.CustomerSubC, t.DepartureC, t.DestinationC, t.ContainerSizeI, t.UnitPrice, t.CalculateByTon });
			...
			this.ToTable("ContractPartnerPattern_M");
